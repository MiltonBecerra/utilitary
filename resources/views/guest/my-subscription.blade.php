                ...
                <div class="card-body">
                    ...
                    @if($currentSubscription)
                        ...
                        @if($email)
                            <div class="alert alert-info mb-4">
                                <strong><i class="fas fa-envelope"></i> Email registrado:</strong> {{ $email }}
                            </div>
                        @endif
                        ...
                        @if($currentSubscription->plan_type != 'pro')
                            <div class="text-center mb-4">
                                <a href="{{ route('guest.subscription.upgrade') }}" class="btn btn-primary btn-lg">
                    ...
                    @else
                        <div class="alert alert-warning">
                            ...
                            <p>Estás usando el plan gratuito. Actualiza para disfrutar de más beneficios.</p>
                            <a href="{{ route('guest.subscription.upgrade') }}" class="btn btn-primary">
                    ...
                    <div class="alert alert-info mt-4">
                        <strong><i class="fas fa-lightbulb"></i> Importante:</strong> Tus datos están guardados en este navegador mediante cookies. 
                        <a href="{{ route('register') }}" class="alert-link">Regístrate</a> para acceder desde cualquier dispositivo y guardar tus datos permanentemente.
                    </div>
                    ...
                    <div class="text-center mt-4">
                        <a href="{{ route('currency-alert.index') }}" class="btn btn-outline-primary">
